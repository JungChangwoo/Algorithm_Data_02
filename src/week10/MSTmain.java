...
public class MSTmain {
	...
	public static void main(String[] args) {
		...
		myG2.deleteVertex("서울");
		myG2.showGraph();
		 
		myG2.insertEdge("서울", "인천", 11);
		myG2.insertEdge("서울", "대전", 8);
		myG2.insertEdge("서울", "대구", 9);
		myG2.showGraph();

		System.out.println("\nAdjacent Set of "+"서울");
		System.out.println(myG2.adjacent("서울"));
		
		System.out.println("\nPrimWithHeap Algorithm starts from "+"서울");
