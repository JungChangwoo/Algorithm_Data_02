...
public class GraphInArray {
	...
	public void createGraph(String name) {
		...
		adjacentList = new ArrayList<ArrayList<String>>();	
	}
	...
	public void insertEdge(String from, String to) {
		...
		vertices.set(f, vertices.get(f)+1);
		vertices.set(t, vertices.get(t)+1);
	}	
	...
	public void deleteEdge(String from, String to) {
		...
		if (f>=0 && t>=0) {
			...
			vertices.set(f, Integer.toString(Integer.parseInt(vertices.get(f))-1));
			vertices.set(t,  Integer.toString(Integer.parseInt(vertices.get(t))-1));
		}
	}
