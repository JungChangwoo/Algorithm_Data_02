...
import week12.GraphInMatrixWD;

public class DijkstraMatrix extends GraphInMatrixWD {
	int [] d  ;   // distance; 
	int r = -1;   // start node
	HashSet<String> S, V ;
	...
	public static void main(String[] args) {
		...
		DijkstraMatrix myG = new DijkstraMatrix(vertices.length);
